  ...
  module RequestHandlers
    module Subscriptions
      ...
      def create_subscription(route, method_url, params, headers)
        ...
        allowed_params = %w(application_fee_percent automatic_tax backdate_start_date billing billing_cycle_anchor cancel_at cancel_at_period_end collection_method coupon created current_period_start customer days_until_due default_payment_method default_tax_rates enable_incomplete_payments expand id idempotency_key items metadata off_session payment_behavior payment_settings pending_invoice_item_interval plan prorate proration_behavior quantity source tax_percent transfer_data trial_end trial_from_plan trial_period_days trial_settings)
      ...
      def verify_card_present(customer, plan, subscription, params={})
        ...
        return if params[:billing] == 'send_invoice' || params[:collection_method] == 'send_invoice'
